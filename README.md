...
A bare-metal rust hardware project incorporating an ESP32C3, a NEO-6M GPS Flight Controller Module, a BNO055 9-axis absolute orientation sensor and a strip of neopixels arranged in sequence in a single loop on the circumerence of a hat brim.
...
I believe there are a still a few bugs in the orientation tracking.  The directional indicators do not consistently point "forward" during motion tests.
